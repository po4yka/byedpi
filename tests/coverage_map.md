...
| Rust runtime subset | `ciadpi-rs` SOCKS4, SOCKS5 CONNECT, HTTP CONNECT, TLS tunneling, churn, no-domain rejection, no-udp rejection, connect failure handling, and SOCKS chaining | `tests/test_rust_runtime_subset.py` |
