...
- `make test` also runs the desync runtime suite against `ciadpi-rs`, so stream-visible tampering and Linux loopback wire behavior stay gated on the Rust binary too
